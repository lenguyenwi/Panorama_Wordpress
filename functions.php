...
TEMPLATE FUNCTION
**/
if(!function_exists('lenguyen_header')){
  function lenguyen_header(){ ?>
        <div class ="site-name">
  <?php  if(is_home()){
      printf('<h1><a href = "%1$s" title="%2$s">%3$s</a></h1>',
      // get_bloginfo('url'),
      home_url('url'),
      get_bloginfo('decription'),
...
<div class = "side-decription"><?php bloginfo('decription');?></div>
  <?php
  }
}
...
Thiet lap menu
**/
if(!function_exists('lenguyen_menu')){
  function lenguyen_menu($menu){
    $menu = array(
      'theme_location'=>$menu,
      'container'=>'nav',
...
/*====== nhung file style.css=====*/
 ...
 add_action('wp_enqueue_scripts','lenguyen_style');

/***-------- End new functions Le---------------------------------------------------------------------------------------------------***/
